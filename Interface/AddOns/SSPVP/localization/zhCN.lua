...
L["Announcement channel"] = "通告频道"
L["Queue overlay"] = "队列覆盖"
L["Enable battlefield queue overlay"] = "启用战场队列覆盖"
L["Show queue overlay inside battlefields"] = "战场内显示队列覆盖"
L["Lock node capture bar"] = "锁定节点捕获条"
L["Grow display up"] = "增长显示"
L["Use HH:MM:SS short time format"] = "使用 HH:MM:SS 短时间格式"
L["Show resources lost from objectives in SCT/FCT/MSBT/ect"] = "在SCT/FCT/MSBT/中显示目标丢失的资源"
L["Alert interval"] = "警报间隔"
L["Interval frequency increase"] = "间隔频率增加"
L["Show flag respawn time on overlay"] = "覆盖显示旗帜刷新时间"
