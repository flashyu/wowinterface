...
dialogHeader:SetText( "这些选项允许您控制哪些图标显示在物品的鼠标提示上.\n任务图标可以被过滤，显示在特定类别/职业的任务所需的物品上." )
...
dmfCheck = CreateCheckbox( "ItemTooltipIconsConfigCheck3", 20, -490, " 暗月马戏团项目", "Display a ticket icon if the item can be exchanged for Darkmoon Faire tickets" )
